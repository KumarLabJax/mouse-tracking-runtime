...
# Examples:
#   python tools/sampleposeintervals.py \
#       --batch-file ~/projects/gaitanalysis/data/metadata/strain-survey-batch-2019-05-29.txt \
#       --root-dir ~/smb/labshare \
#       --out-dir poseintervals-temp \
#       --out-frame-count 1800 \
#       --start-frame 500
...
#       --out-dir BTBR_3M_stranger_4day-batch-temp-intervals \
#       --out-frame-count 1800 \
#       --start-frame 500

#   share_root='/run/user/1000/gvfs/smb-share:server=bht2stor.jax.org,share=vkumar'
#   python tools/sampleposeintervals.py \
#       --batch-file ~/temp/BXD_Rotta_TS.txt \
#       --root-dir "${share_root}" \
#       --out-dir BXD_Rotta_TS-intervals \
...
#   share_root='/run/user/1000/gvfs/smb-share:server=bht2stor.jax.org,share=vkumar'
#   python tools/sampleposeintervals.py \
#       --batch-file ~/temp/UCSD_Rotta_TS.txt \
#       --root-dir "${share_root}" \
#       --out-dir UCSD_Rotta_TS-intervals \
#       --out-frame-count 9000 \
#       --start-frame 54000 \
#       --pose-version 3
...
#   share_root='/run/user/1000/gvfs/smb-share:server=bht2stor.jax.org,share=vkumar'
#   python tools/sampleposeintervals.py \
#       --batch-file ~/temp/B2B_Rotta_TS.txt \
#       --root-dir "${share_root}" \
#       --out-dir B2B_Rotta_TS-intervals \
#       --out-frame-count 9000 \
#       --start-frame 54000 \
#       --pose-version 3
        ...
        for line in batch_file:
            ...
            if vid_filename:
                ...
                with h5py.File(pose_in_path, 'r') as pose_in:
                    ...
                    # print('-----')
                    # print('pose_in_path:', pose_in_path)
                    # print('vid_path:', vid_path)
                    # print('pose_out_path:', pose_out_path)
                    # print('vid_out_path:', vid_out_path)
