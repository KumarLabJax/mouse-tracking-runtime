...
import time
import sys
from utils.segmentation import get_contours, pad_contours, render_segmentation_overlay, merge_multiple_seg_instances
...
from models.model_definitions import MULTI_MOUSE_SEGMENTATION
...
def infer_multi_segmentation_tfs(args):
	...
	write_seg_data(args.out_file, segmentation_matrix, flag_matrix, model_definition['model-name'], model_definition['model-checkpoint'], True)
