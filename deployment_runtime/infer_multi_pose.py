...
import sys
import os
from ort_inference import infer_multi_pose_ort
...
def main(argv):
	...
	parser.add_argument('--runtime', help='Runtime to execute the model.', default='ort', choices=['ort'])
