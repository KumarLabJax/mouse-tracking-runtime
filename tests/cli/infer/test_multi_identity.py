...
class TestMultiIdentityImplementation:
    ...
    def test_multi_identity_file_existence_validation(self, file_exists, expected_success):
        """
    ...
    def test_multi_identity_mouse_identity_specific_functionality(self):
        ...
        cmd_args = [
            "multi-identity",
            "--out-file", "mouse_identities.json",
            "--video", str(self.test_video_path),
            "--model", "2023",
            "--runtime", "tfs",
        ]
    ...
    def test_multi_identity_maximum_configuration(self):
        ...
        cmd_args = [
            "multi-identity",
            "--out-file", "complete_identity_output.json",
            "--video", str(self.test_video_path),
            "--model", "2023",
            "--runtime", "tfs",
        ]
